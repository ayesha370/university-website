      ...
      <footer>
        <div className='container my-5'>
          ...
          <div className='col-md-7 col-lg-6'>
            <div className='d-row d-md-flex justify-content-between algn-items-center'>
              <div className='col-12 col-md-6 col-lg-5 mb-5 mt-4 my-md-0'>
                <ul className='footer-navigation list-unstyled mb-0'>
                  <Link to='/' className='text-decoration-none text-danger'>
                    <li className='nav-item text-uppercase fw-semibold'>
                      Home
                    </li>
                  </Link>
              ...
              <div className='col-12 col-md-6 col-lg-7'>
                <ul className='list-unstyled mb-0'>
                  ...
                  <li>
                    <p>Phone Number - 0900 98219778</p>
                  </li>
                  <li>
                    <p>Email - University@iba.co.edu.pk</p>
                  </li>
                </ul>
              </div>
            </div>
